...
- Name: products/sorting.spec.js >> Catalogue sorting @regression >> TC-012 | the catalogue can be sorted by "Price (low to high)"
- Location: tests/products/sorting.spec.js:47:5
