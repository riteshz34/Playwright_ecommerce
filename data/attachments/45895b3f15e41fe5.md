...
- Name: cart/cart.spec.js >> Shopping cart @regression >> with a pre-loaded cart >> TC-016 | a product can be removed from the cart screen
- Location: tests/cart/cart.spec.js:76:5
