...
- Name: checkout/checkout.spec.js >> Checkout @regression >> TC-020 | a shopper can complete an order end to end @smoke @e2e
- Location: tests/checkout/checkout.spec.js:13:3
