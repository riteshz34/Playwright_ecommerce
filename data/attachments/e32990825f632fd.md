...
- Name: cart/cart.spec.js >> Shopping cart @regression >> TC-015 | several products can be added and the badge counts them all
- Location: tests/cart/cart.spec.js:39:3
