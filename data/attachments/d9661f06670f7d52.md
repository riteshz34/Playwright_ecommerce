...
- Name: navigation/session.spec.js >> Navigation and session @regression >> TC-027 | "Reset App State" clears the cart
- Location: tests/navigation/session.spec.js:71:3
